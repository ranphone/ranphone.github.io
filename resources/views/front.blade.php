        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post post-thumb">
                    <a class="post-img" href="{{ route('artikel.detail', $a->judul) }}">
                        <img src="{{ asset('uploads/'.$a->gambar) }}" alt="" width="300" height="300"></a>
                    <div class="post-body">
                        <div class="post-meta">
                            <a class="post-category cat-2" href="{{ route('artikel.kategori', $a->kategori->nama_kategori) }}">{{$a->kategori->nama_kategori}}</a>
                            <span class="post-date">{{$a->created_at->diffForHumans()}}</span>
                        </div>
                        <h3 class="post-title"><a href="{{ route('artikel.detail', $a->judul) }}">
                                {{$a->judul}}
                            </a></h3>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="post">
                            <a class="post-img" href="{{ route('artikel.detail',$all->judul) }}">
                                <img src="{{ asset('uploads/'.$all->gambar) }}" alt="" height="250px" width="250px"></a>
                            <div class="post-body">
                                <div class="post-meta">
                                    <a class="post-category cat-2" href="{{ route('artikel.kategori',$all->kategori->nama_kategori) }}">
            ...
            <div class="col-md-4">
                ...
                <div class="aside-widget">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="{{ route('artikel.detail',$terkait->judul) }}">
