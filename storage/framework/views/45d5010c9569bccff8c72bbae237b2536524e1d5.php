        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post post-thumb">
                    <a class="post-img" href="<?php echo e(route('artikel.detail', $a->judul)); ?>">
                        <img src="<?php echo e(asset('uploads/'.$a->gambar)); ?>" alt="" width="300" height="300"></a>
                    <div class="post-body">
                        <div class="post-meta">
                            <a class="post-category cat-2" href="<?php echo e(route('artikel.kategori', $a->kategori->nama_kategori)); ?>"><?php echo e($a->kategori->nama_kategori); ?></a>
                            <span class="post-date"><?php echo e($a->created_at->diffForHumans()); ?></span>
                        </div>
                        <h3 class="post-title"><a href="<?php echo e(route('artikel.detail', $a->judul)); ?>">
                                <?php echo e($a->judul); ?>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="post">
                            <a class="post-img" href="<?php echo e(route('artikel.detail',$all->judul)); ?>">
                                <img src="<?php echo e(asset('uploads/'.$all->gambar)); ?>" alt="" height="250px" width="250px"></a>
                            <div class="post-body">
                                <div class="post-meta">
                                    <a class="post-category cat-2" href="<?php echo e(route('artikel.kategori',$all->kategori->nama_kategori)); ?>">
                                        <?php echo e($all->kategori->nama_kategori); ?>

                                    </a>
                                    <span class="post-date"><?php echo e($all->created_at); ?></span>
                                </div>
                                <h3 class="post-title">
            ...
            <div class="col-md-4">
                ...
                <div class="aside-widget">
                    ...
                    <div class="post post-widget">
                        <a class="post-img" href="<?php echo e(route('artikel.detail',$terkait->judul)); ?>">
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ranphone\resources\views/front.blade.php ENDPATH**/ ?>