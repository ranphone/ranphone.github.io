        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="/" class="logo"><img src="<?php echo e(asset('front/img/your-logo.png')); ?>" alt="" style="width: 200px;"></a>
                    </div>
                    <!-- /logo -->
            ...
            <div id="nav-aside">
                ...
                <div class="section-row">
                    <ul class="nav-aside-menu">
                        ...
                        <li><a href="<?php echo e(route('home')); ?>">Login Admin</a></li>
                    </ul>
                </div>
                <!-- /nav -->
...
</html><?php /**PATH C:\xampp\htdocs\ranphone\resources\views/template/app.blade.php ENDPATH**/ ?>