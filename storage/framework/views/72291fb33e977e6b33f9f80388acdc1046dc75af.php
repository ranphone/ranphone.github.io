        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post post-thumb">
                    <a class="post-img" href="Artikel/<?php echo e($a->judul); ?>">
                        <img src="<?php echo e(asset('uploads/'.$a->gambar)); ?>" alt="" width="300" height="300"></a>
                    <div class="post-body">
                        <div class="post-meta">
                            <a class="post-category cat-2" href="Artikel-kategori/<?php echo e($a->kategori->nama_kategori); ?>"><?php echo e($a->kategori->nama_kategori); ?></a>
                            <span class="post-date"><?php echo e($a->created_at->diffForHumans()); ?></span>
                        </div>
                        <h3 class="post-title"><a href="Artikel/<?php echo e($a->judul); ?>">
                                <?php echo e($a->judul); ?>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_blog\resources\views/front.blade.php ENDPATH**/ ?>