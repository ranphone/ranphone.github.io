        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo">
                        <a href="/" class="logo"><img src="<?php echo e(asset('front/img/logo.png')); ?>" alt=""></a>
                    </div>
                    <!-- /logo -->

                    <!-- nav -->
                    <?php echo $__env->yieldPushContent('nav'); ?>
                    <!-- /nav -->
                ...
                <div class="col-md-5">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="index.html" class="logo"><img src="<?php echo e(asset('front/img/logo.png')); ?>" alt=""></a>
                        </div>
                        <ul class="footer-nav">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="footer-widget">
                                ...
                                <?php echo $__env->yieldPushContent('categoris'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel_blog\resources\views/template/app.blade.php ENDPATH**/ ?>